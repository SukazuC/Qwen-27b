...
// Mobile social icons (includes YouTube and Email)
  ...
  },
  {
    ...
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
        ...
        <polygon fill="var(--color-bg-warm)" points="9.545 15.568 15.18 12 9.545 8.432" />
      </svg>
    ),
  },
  {
  ...
  return (
    ...
    >
      ...
      <path
        ...
        opacity="0.6"
      />
      <circle cx="26" cy="14" r="1.5" fill="var(--color-bg-warm)" />
    </svg>
  );
}
...
export default function SiteFooter() {
  return (
    <footer
      className="border-t border-[var(--color-border-gold)] bg-[var(--color-bg-warm)]"
      role="contentinfo"
    >
      <div className="container-max">
        ...
        <div className="px-4 py-8 md:hidden">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="h-10 w-px bg-[var(--color-border-gold)]" />
            <nav
              className="flex flex-col gap-2 text-xs"
              aria-label="Navigation du pied de page mobile"
            >
              <div className="flex flex-wrap gap-x-6 gap-y-1">
                {mobileNavRow1.map((link) => (
                  <a
                    key={link.label}
                    href={link.href}
                    className="font-medium uppercase tracking-widest text-[var(--color-muted)] transition-colors hover:text-[var(--color-gold)]"
                  >
                    {link.label}
                  </a>
                ))}
          ...
          {/* Social icons row */}
          <div className="mt-6 flex items-center justify-center gap-8 border-t border-[var(--color-border-gold)] pt-6">
          ...
          {/* Copyright + legal */}
          <div className="mt-4 flex flex-wrap items-center justify-center gap-4 border-t border-[var(--color-border-gold)] pt-4 text-xs text-[var(--color-muted)]">
        ...
        <div className="hidden md:block">
          ...
          <div className="grid grid-cols-[auto,1fr] gap-12 py-12">
            ...
            {/* Nav + Social columns with vertical dividers */}
            <div className="grid grid-cols-5 gap-6">
              {footerNav.map((col, i) => (
                <div key={col.title} className={i > 0 ? "border-l border-[var(--color-border-gold)] pl-6" : ""}>
              ...
              {/* Social column */}
              <div className="border-l border-[var(--color-border-gold)] pl-6">
          ...
          <div className="flex items-center justify-between py-4">
            ...
            <span className="font-display text-lg tracking-[0.2em] text-[var(--color-gold)]/60">
              HYDRE
              <span className="block text-[10px] tracking-[0.3em]">NUTRITION</span>
            </span>
